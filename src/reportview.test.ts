...
function synthLog(selections: number, errEvery: number): RunLog {
  ...
  return {
    ...
    meta: {
      ...
      config: { alphabet: 'asdfjkl;', n: 8, leftFingers: 'asdf', rightFingers: 'jkl;', thumbs: false, leftThumb: '', rightThumb: '', lookahead: 7, lanes: true, chord: false, sound: true, errorFeedback: 'flash', durationMs: 60000 },
    },
